...
$primary-font: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, Helvetica, sans-serif;
$primary-font-size: 14px;
$monospace-font: 'SF Mono', 'Cascadia Code', 'Fira Code', Menlo, Consolas, 'DejaVu Sans Mono', Courier, monospace;

$primary-background: #f0f0f0;

$secondary-background: #fff;
$secondary-background-selected: #efefef;
$secondary-background-inactive: #f0f0f0;
$secondary-background-hover: #e8e8e8;
$secondary-background-disabled: #f9f9f9;
...
$secondary-text-color-focus: #666;
$secondary-text-color-hover: #666;
...
$text-color-code: #2d7de9;
$text-color-link: #2d7de9;
...
$text-editor-gutter-background: #f6f6f6;
$text-editor-gutter-color: #666;
$text-editor-gutter-active-line-background: #dcdcdc;
$text-editor-active-line-background: #efefef;
...
$view-lasso-stroke: #2d7de9; 
$view-lasso-fill: rgba(45,125,233,0.1);
...
$node-selected-color: #2d7de9;
$port-selected-color: #2d7de9;

$link-color: #999;
$link-link-color: #aaa;
$link-disabled-color: #ccc;
$link-link-active-color: #2d7de9;
