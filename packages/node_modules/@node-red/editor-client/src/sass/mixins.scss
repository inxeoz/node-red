...
@mixin reset-a-style {
    ...
    &:not(.disabled):not(:disabled):not(.primary):focus {
...
@mixin workspace-button {
    ...
    &.selected:not(.disabled):not(:disabled) {
        ...
        border-color: var(--red-ui-workspace-button-border-selected);
    }
...
@mixin component-shadow {
    box-shadow: 0 1px 3px var(--red-ui-shadow);
...
@mixin menu-light-theme {
    ...
    box-shadow: 0 2px 8px var(--red-ui-shadow);
